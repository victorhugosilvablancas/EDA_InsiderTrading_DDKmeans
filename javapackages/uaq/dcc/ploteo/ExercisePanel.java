...
public class ExercisePanel extends JPanel {
    ...
    public ExercisePanel(String aclusters,String aepochs) {
        ...
        for (int i=0;i<Exercisesdata.listpricepershares.size();i++) {
            data=Exercisesdata.listpricepershares.get(i);
    ...
    private class KmeansForExercises extends Kmeans {
        ...
        public void Execute() {
            ...
            for(int j = 0; j < Kmeans.Cluster.length; j++) {
                ...
                Random rn=new Random();
                int k=rn.nextInt(0, Exercisesdata.listpricepershares.size());
                Exercisesdata tdata=Exercisesdata.listpricepershares.get(k);
        ...
        */
        public final void DataInitialization() {
            ...
            for (int i=0;i<Exercisesdata.listpricepershares.size();i++) {
                dfdata=Exercisesdata.listpricepershares.get(i);
